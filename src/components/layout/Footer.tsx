...
export function Footer() {
  ...
  return (
    <footer className="bg-blue-700 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 pb-8">
        {/* Main content: 1-col mobile → 2-col tablet (company spans 2) → 3-col desktop */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_160px_160px] gap-8">
          {/* Company Info */}
        ...
        <div className="mt-8 flex justify-center items-center">
          <div className="flex items-center gap-6">
            ...
            >
              <Image src="/anpc-sal.png" alt="ANPC SAL" width={140} height={70} className="h-[70px] w-auto" />
            </Link>
            <Link
              ...
              className="hover:opacity-80 transition-opacity"
            >
              <Image src="/anpc-sol.png" alt="ANPC SOL" width={140} height={70} className="h-[70px] w-auto" />
            </Link>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-blue-600">
          <div className="flex justify-center items-center">
            <p className="text-blue-200 text-sm flex items-center space-x-1">
              <span>© {currentYear} Made by Codemint with</span>
